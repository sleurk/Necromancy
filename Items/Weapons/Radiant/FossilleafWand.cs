...
{
	public class FossilleafWand : ModItem
	{
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Fossil-Leaf Wand");
        }
        ...
        public override void SetDefaults()
        {
			...
			item.autoReuse = true;
			item.shoot = mod.ProjectileType("EnergyBlue");
			item.shootSpeed = 3f;
            item.prefix = 0;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.WaterleafSeeds, 5);
