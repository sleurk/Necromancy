...
{
	public class MagmastarPiccolo : ModItem
	{
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Magmastar Piccolo");
            Tooltip.SetDefault("Shoots some wavy sound" +
                "\nEmpowers allies with bonus maximum mana");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.autoReuse = true;
            item.shoot = mod.ProjectileType("MagmastarPulse");
            item.shootSpeed = 3f;
            item.prefix = 0;
