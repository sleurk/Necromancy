...
{
    public class TauntingAltar : Altar
    {
        public override void SetDefaults()
        {
            ...
            name.SetDefault("Taunting Altar");
        ...
        public override bool CreateRitual(int chalk, int i, int j)
        {
            ...
            Projectile projectile = Projectile.NewProjectileDirect(pos, Vector2.Zero, mod.ProjectileType("Taunting" + chalkName[chalk]), 0, 0f, Main.myPlayer);
