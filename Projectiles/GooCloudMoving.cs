...
{
    public class GooCloudMoving : ModProjectile
    {
        // nimbus rod clone, cloud after being shot
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile proj = Projectile.NewProjectileDirect(startPos, new Vector2(0, 0), mod.ProjectileType("GooCloudRaining"), projectile.damage, projectile.knockBack, projectile.owner);
            proj.netUpdate = true;
