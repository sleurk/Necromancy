        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                for (int k = 0; k < chargeFact + 1; k++)
                {
                    ...
                    Dust dust = Main.dust[Dust.NewDust(pos, 20, 20, 246, projectile.velocity.X / 2f,
            ...
            Vector2 unit = projectile.velocity;
            unit *= -1;
            for (Distance = MOVE_DISTANCE; Distance <= 400f; Distance += 5f)
            {
            ...
            for (int i = 0; i < 2; ++i)
            {
                ...
                Dust dust = Main.dust[Dust.NewDust(dustPos, 0, 0, 246, dustVel.X, dustVel.Y, 0, new Color(), 1f)];
                dust.noGravity = true;
                dust.scale = 2f;
                ...
                dust = Main.dust[Dust.NewDust(Main.player[projectile.owner].Center + unit * 5f, 0, 0, 246, unit.X, unit.Y, 0, new Color(), 1f)];
                dust.fadeIn = 0f;
                dust.noGravity = true;
                dust.scale = 0.88f;
            }
